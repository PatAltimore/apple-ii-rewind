...
- USB/Bluetooth gamepads are picked up by apple2js's Gamepad API support and act as the joystick: the left stick moves it, **A**/**B**/left-bumper/right-bumper are the two fire buttons, and **Start** sends Esc.
